	...
	<div class="breadcrumb_dress">
		<div class="container">
			<ul>
				...
				<li>WONDERCHEF 19-Litre OTG Oven</li>
			</ul>
		</div>
	</div>
	<!-- //breadcrumbs -->  
		...
		<div class="container">
			<div class="col-md-4 single-left">
				<div class="flexslider">
					<ul class="slides">
						<li data-thumb="images/o1.jpg">
							<div class="thumb-image"> <img src="images/o1.jpeg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li>
						<li data-thumb="images/o2.jpg">
							 <div class="thumb-image"> <img src="images/o2.jpeg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li>
						<li data-thumb="images/o3.jpg">
						   <div class="thumb-image"> <img src="images/o3.jpeg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li> 
					</ul>
				</div>
				<!-- flexslider -->
			...
			<div class="col-md-8 single-right">
				<h3>WONDERCHEF 19-Litre OTG Oven </h3>
				
				<div class="description">
					<h5><i>Description</i></h5>
					<p>Capacity :19 L<br>
                        Timer: Yes<br>
                        Temperature Control Range :100 to 250 Degree degree C<br>
                        Power Consumption :1280 W<br>
                        Power Requirement :50Hz, 220V<br>
                        Width: 355 mm<br>
                        Height: 337 mm<br>
                        Depth: 475 mm<br>
                        Weight: 5 kg<br>
                        Warranty Summary: 1 Year Wonderchef Warranty
                        </p>
				</div>
				<div class="color-quality">
					<div class="color-quality-left">
						<h5>Colors : </h5>
						<ul>
							<li><a href="#" style="color: gray;">Load Gray</a></li><br>
                ...
                <div class="occasional">
					<h5>Power Consumption & Capacity :</h5>
					<div class="colr ert">
						<div class="check">
							<label class="checkbox"><input type="checkbox" name="checkbox" ><i> </i>650W + 9L</label>
						</div>
					</div>
					<div class="colr">
						<div class="check">
							<label class="checkbox"><input type="checkbox" name="checkbox"><i> </i>1280W + 19L</label>
						</div>
					</div>
