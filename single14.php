	...
	<div class="breadcrumb_dress">
		<div class="container">
			<ul>
				...
				<li>KENT ULTRA STORAGE Water Purifier </li>
			</ul>
		</div>
	</div>
	<!-- //breadcrumbs -->  
	...
	<div class="single">
		<div class="container">
				...
				<div class="flexslider">
					<ul class="slides">
						<li data-thumb="images/k1.jpg">
							<div class="thumb-image"> <img src="images/k1.jpeg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li>
						<li data-thumb="images/k2.jpg">
							 <div class="thumb-image"> <img src="images/k2.jpeg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li>
						<li data-thumb="images/k3.jpg">
						   <div class="thumb-image"> <img src="images/k3.jpeg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li> 
					</ul>
				</div>
				<!-- flexslider -->
			...
			<div class="col-md-8 single-right">
				<h3>KENT ULTRA STORAGE 8 L UV + UF Water Purifier  (Blue) </h3>
				
				<div class="description">
					<h5><i>Description</i></h5>
					<p>Electrical & Storage : Electric purification - suitable for areas with water shortage<br>
                        8 L : More the capacity, more the users can be served with drinking water<br>
                        UV + UF : Uses many filters to remove salts & microbes in multiple stages
                        </p>
				</div>
				<div class="color-quality">
					<div class="color-quality-left">
						<h5>Colors : </h5>
						<ul>
							<li><a href="#" style="color: blue;">Blue</a></li><br>
                ...
                <div class="occasional">
					...
					<div class="colr ert">
						<div class="check">
							<label class="checkbox"><input type="checkbox" name="checkbox" ><i> </i>8L</label>
						</div>
					</div>
			...
			<div class="sap_tabs">	
				<div id="horizontalTab1" style="display: block; width: 100%; margin: 0px;">
					...
					<div class="tab-1 resp-tab-content additional_info_grid" aria-labelledby="tab_item-0">
						<h3>KENT ULTRA STORAGE 8 L UV + UF Water Purifier </h3>
