	...
	<div class="breadcrumb_dress">
		<div class="container">
			<ul>
				...
				<li>Mi 5X LED Smart Android Tv</li>
			</ul>
		</div>
	</div>
	<!-- //breadcrumbs -->  
		...
		<div class="container">
			<div class="col-md-4 single-left">
				<div class="flexslider">
					<ul class="slides">
						<li data-thumb="images/h1.jpg">
							<div class="thumb-image"> <img src="images/h1.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li>
						<li data-thumb="images/h3.jpg">
							 <div class="thumb-image"> <img src="images/h3.jpeg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li>
						<li data-thumb="images/h4.jpg">
						   <div class="thumb-image"> <img src="images/h4.jpeg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li> 
					</ul>
				</div>
				<!-- flexslider -->
			...
			<div class="col-md-8 single-right">
				<h3>Mi 5X 108 cm (43 inch) Ultra HD (4K) LED Smart Android TV with Dolby Atmos and Dolby Vision</h3>
				...
				<div class="color-quality">
					<div class="color-quality-left">
						<h5>Colors : </h5>
						<ul>
							<li><a href="#" style="color: black;">Black</a></li><br>
                ...
                <div class="occasional">
					...
					<div class="colr ert">
						<div class="check">
							<label class="checkbox"><input type="checkbox" name="checkbox" ><i> </i>43 inches</label>
						</div>
					</div>
					<div class="colr">
						<div class="check">
							<label class="checkbox"><input type="checkbox" name="checkbox"><i> </i>50 inches</label>
						</div>
					</div>
                    <div class="colr">
						<div class="check">
							<label class="checkbox"><input type="checkbox" name="checkbox"><i> </i>55 inches</label>
						</div>
					</div>
			...
			<div class="sap_tabs">	
				<div id="horizontalTab1" style="display: block; width: 100%; margin: 0px;">
					...
					<div class="tab-1 resp-tab-content additional_info_grid" aria-labelledby="tab_item-0">
						<h3>mi 5X LED Smart Tv</h3>
						<p>>Supported Apps: Netflix|Prime Video|Disney+Hotstar|Youtube<br>
                            Operating System: Android (Google Assistant & Chromecast in-built)<br>
                            Resolution: Ultra HD (4K) 3840 x 2160 Pixels</p>
					</div>	
						...
						<div class="additional_info_sub_grids">
							...
							<div class="col-xs-10 additional_info_sub_grid_right">
								<div class="additional_info_sub_grid_rightl">
									...
									<h3>Rahul Yadav</h3>
									<h5>Dec 06, 2021.</h5>
									<p>Very Best TV. Sound Quality Is Very Nice.</p>
								</div>
