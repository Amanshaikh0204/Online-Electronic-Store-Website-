				...
				<div class="flexslider">
					<ul class="slides">
						<li data-thumb="images/6.jpg">
							<div class="thumb-image"> <img src="images/6.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li>
						<li data-thumb="images/7.jpg">
							 <div class="thumb-image"> <img src="images/7.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li>
						<li data-thumb="images/8.jpg">
						   <div class="thumb-image"> <img src="images/8.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li> 
					</ul>
				</div>
				<!-- flexslider -->
			...
			<div class="col-md-8 single-right">
				...
				<div class="description">
					...
					<p>One Plus Nord 2 5G Comes With 6.43-inch (1080x2400) Fulid Amoled Display With 90 Hz Refresh Rate. It Has Processor MediaTek Dimensity 1200. It Comes With Front Camera
                        32MP And Rear Tri Camera 50MP + 8MP + 2MP. It Has Ram 8GB/12GB and Storage With 128GB/256GB. It's Battery Capacity is 4500mAh And it Comes With OS Android 11. One Plus Nord 2 5G Comes in 3 Different Colors That are Gray Sierra, Blue Haze And Green Wood.</p>
				</div>
				<div class="color-quality">
					<div class="color-quality-left">
						<h5>Colors : </h5>
						<ul>
							<li><a href="#" style="color: gray;">Gray Sierra</a></li><br>
							<li><a href="#" style="color: lightblue;">Blue Haze</a></li><br>
				...
				<div class="occasional">
					...
					<div class="colr">
						<div class="check">
							<label class="checkbox"><input type="checkbox" name="checkbox"><i> </i>12GB+256GB</label>
						</div>
					</div>
			...
			<div class="sap_tabs">	
				<div id="horizontalTab1" style="display: block; width: 100%; margin: 0px;">
					...
					<div class="tab-1 resp-tab-content additional_info_grid" aria-labelledby="tab_item-0">
						<h3>The Best 5G Mobile Phone Under ₹33,999</h3>
						<p>>One Plus Nord 2 5G Comes With 6.43-inch (1080x2400) Fulid Amoled Display With 90 Hz Refresh Rate. It Has Processor MediaTek Dimensity 1200. It Comes With Front Camera
						...
						<div class="additional_info_sub_grids">
							...
							<div class="col-xs-10 additional_info_sub_grid_right">
								<div class="additional_info_sub_grid_rightl">
									...
									<h3>Rahul Yadav</h3>
									<h5>Dec 06, 2021.</h5>
									<p>Very Best 5G Phone Under 33000. It Has Very Smooth Display and Battery Performance is Very High</p>
								</div>
						...
						<div class="additional_info_sub_grids">
							...
							<div class="col-xs-10 additional_info_sub_grid_right">
								<div class="additional_info_sub_grid_rightl">
									<h3>Vikas Singh</h3>
									<h5>Jan 21, 2022.</h5>
									<p>Worth Of ₹33999 And Performanceis Ver High.</p>
								</div>
								<div class="additional_info_sub_grid_rightr">
									<div class="rating">
										<div class="rating-left">
