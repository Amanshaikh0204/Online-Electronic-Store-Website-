				...
				<div class="flexslider">
					<ul class="slides">
						<li data-thumb="images/3.jpg">
							<div class="thumb-image"> <img src="images/3.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li>
						<li data-thumb="images/5.jpg">
							 <div class="thumb-image"> <img src="images/5.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li>
						<li data-thumb="images/4.jpg">
						   <div class="thumb-image"> <img src="images/4.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li> 
					</ul>
				</div>
				<!-- flexslider -->
			...
			<div class="col-md-8 single-right">
				...
				<div class="description">
					...
					<p>Redmi Note 10 Pro Max Comes With 6.67-inch (1080x2400) Super Amoled Display. It Has Processor Qualcomm Snapdragon 732G. It Comes With Front Camera
						16MP And Rear Quad Camera 108MP + 8MP + 5MP + 2MP. It Has Ram 6GB/8GB and Storage With 64GB/128GB. It's Battery Capacity is 5020mAh And it Comes With OS Android 11.It Comes With 4 different Colours that are Dark Nebula, Dark Night, Glacial Blue And Vintage Bronze.It's Display Refresh rate is 120 Hz. </p>
				</div>
				<div class="color-quality">
					<div class="color-quality-left">
						...
						<ul>
							...
							<li><a href="#" style="color: purple;">Dark Nebula</a></li><br>
							<li><a href="#" style="color: black;">Dark Night</a></li><br>
							<li><a href="#" style="color: blue;">Glacial Blue</a></li><br>
			...
			<div class="sap_tabs">	
				<div id="horizontalTab1" style="display: block; width: 100%; margin: 0px;">
					...
					<div class="tab-1 resp-tab-content additional_info_grid" aria-labelledby="tab_item-0">
						<h3>The Best 4G Mobile Phone Under ₹19,999</h3>
						<p>>Redmi Note 10 Pro Max Comes With 6.67-inch (1080x2400) Super Amoled Display. It Has Processor Qualcomm Snapdragon 732G. It Comes With Front Camera
						...
						<div class="additional_info_sub_grids">
							...
							<div class="col-xs-10 additional_info_sub_grid_right">
								<div class="additional_info_sub_grid_rightl">
									...
									<h3>Rahul Yadav</h3>
									<h5>Dec 06, 2021.</h5>
									<p>Very Best Phone Under 20000. It Has Very Smooth Display and Battery Performance is Very High</p>
								</div>
						...
						<div class="additional_info_sub_grids">
							...
							<div class="col-xs-10 additional_info_sub_grid_right">
								<div class="additional_info_sub_grid_rightl">
									<h3>Vikas Singh</h3>
									<h5>Jan 21, 2022.</h5>
									<p>Worth Of ₹19999 And Super Amoled Display is Very Awesome.</p>
								</div>
								<div class="additional_info_sub_grid_rightr">
									<div class="rating">
										<div class="rating-left">
