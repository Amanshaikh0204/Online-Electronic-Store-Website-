	...
	<div class="breadcrumb_dress">
		<div class="container">
			<ul>
				...
				<li>JBL C100SI In Ear Wired Earphones with Mic</li>
			</ul>
		</div>
	</div>
	<!-- //breadcrumbs -->  
	...
	<div class="single">
		<div class="container">
				...
				<div class="flexslider">
					<ul class="slides">
						<li data-thumb="images/e1.jpg">
							<div class="thumb-image"> <img src="images/e1.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li>
						<li data-thumb="images/e2.jpg">
							 <div class="thumb-image"> <img src="images/e2.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li>
						<li data-thumb="images/e3.jpg">
						   <div class="thumb-image"> <img src="images/e3.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li> 
					</ul>
				</div>
				<!-- flexslider -->
			...
			<div class="col-md-8 single-right">
				<h3>JBL C100SI In Ear Wired Earphones with Mic</h3>
				...
				<div class="description">
					...
					<p>JBL Signature Sound
                        ...
                        JBL Signature Sound. Frequency range:20-20kHz,Driver sensitivity:100±3dBSPL, 1mW,Maximum SPL:5mW</p>
				</div>
				<div class="color-quality">
					<div class="color-quality-left">
						...
						<ul>
							...
							<li><a href="#" style="color: red;">Red</a></li><br>
			...
			<div class="sap_tabs">	
				<div id="horizontalTab1" style="display: block; width: 100%; margin: 0px;">
					...
					<div class="tab-1 resp-tab-content additional_info_grid" aria-labelledby="tab_item-0">
						<h3>Best JBL Wired Earphone</h3>
						<p>>JBL Signature Sound
                            Extra Deep Bass. Troubleshooting steps : Kindly ensure 3.5mm port on Host device is clean and dust free and 3.5mm jack of the earphone is adequately inserted inside the input device port
                            Noise Cancelling Microphone, Frequency range : 20-20kHz
                            One-Button Universal Remote with Mic
                            Quick Launch Access to Google Assistant / Siri.</p>
					</div>	
						...
						<div class="additional_info_sub_grids">
							...
							<div class="col-xs-10 additional_info_sub_grid_right">
								<div class="additional_info_sub_grid_rightl">
									...
									<h3>Rahul Yadav</h3>
									<h5>Dec 06, 2021.</h5>
									<p>Very Best Earphone Under 599. Sound Quality Is Very Nice.</p>
								</div>
