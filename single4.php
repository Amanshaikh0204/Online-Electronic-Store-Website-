	...
	<div class="breadcrumb_dress">
		<div class="container">
			<ul>
				...
				<li>boAt Rockerz 185 Bluetooth Headset</li>
			</ul>
		</div>
	</div>
	<!-- //breadcrumbs -->  
		...
		<div class="container">
			<div class="col-md-4 single-left">
				<div class="flexslider">
					<ul class="slides">
						<li data-thumb="images/e5.jpg">
							<div class="thumb-image"> <img src="images/e5.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li>
						<li data-thumb="images/e6.jpg">
							 <div class="thumb-image"> <img src="images/e6.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li>
						<li data-thumb="images/e7.jpg">
						   <div class="thumb-image"> <img src="images/e7.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li> 
					</ul>
				</div>
				<!-- flexslider -->
			...
			<div class="col-md-8 single-right">
				<h3>boAt Rockerz 185 Bluetooth Headset</h3>
				...
				<div class="description">
					...
					<p>Connect to your media devices instantly, take the advantage of dual pairing and enjoy real-time audio with Bluetooth v5.0
                        ...
                        The wireless neckband is lightweight in build and IPX4 rated for protection against sweat & water so that you can hit the gym or treadmill being carefree
                        Stay into the groove and flow in the jam with a nonstop playback of up to 15 hours</p>
				</div>
				<div class="color-quality">
					<div class="color-quality-left">
						<h5>Colors : </h5>
						<ul>
							<li><a href="#" style="color: green;">Green Bliss</a></li><br>
						...
						<div class="additional_info_sub_grids">
							...
							<div class="col-xs-10 additional_info_sub_grid_right">
								<div class="additional_info_sub_grid_rightl">
									...
									<h3>Rahul Yadav</h3>
									<h5>Dec 06, 2021.</h5>
									<p>Very Best Bluetooth Headset Under 999. Sound Quality Is Very Nice.</p>
								</div>
						...
						<div class="additional_info_sub_grids">
							...
							<div class="col-xs-10 additional_info_sub_grid_right">
								<div class="additional_info_sub_grid_rightl">
									<h3>Vikas Singh</h3>
									<h5>Jan 21, 2022.</h5>
									<p>Very Best Headset Under 999. Sound Quality Is Very Nice</p>
								</div>
								<div class="additional_info_sub_grid_rightr">
									<div class="rating">
										<div class="rating-left">
