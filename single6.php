		...
		<div class="container">
			<div class="col-md-4 single-left">
				<div class="flexslider">
					<ul class="slides">
						<li data-thumb="images/l1.jpg">
							<div class="thumb-image"> <img src="images/l1.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li>
						<li data-thumb="images/l4.jpg">
							 <div class="thumb-image"> <img src="images/l4.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li>
						<li data-thumb="images/l3.jpg">
						   <div class="thumb-image"> <img src="images/l3.jpeg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li> 
					</ul>
				</div>
				<!-- flexslider -->
			...
			<div class="col-md-8 single-right">
				<h3>RedmiBook 15 Pro</h3>
				
				<div class="description">
					<h5><i>Description</i></h5>
					<p>Processor: 11th Gen Intel Tiger Lake Core i5-11300H processor<br> Speed: 3.1 GHz(base) - 4.4 GHz(max) | 4 cores | 8 Threads | 8 MB Cache | Intel UHD graphics<br>
                        Display: 15.6 inch FHD resolution (1920x1080) |16:9 aspect ratio | Anti Glare<br>
                        Memory & Storage: 8GB DDR4 3200 MHz | 512GB PCIe NVMe M.2 SSD<br>
                        Operating System & Software: Windows 10 Home | Microsoft Office Home and Student 2019 | DTS Audio Processing<br>
                        Ports: 2 SuperSpeed USB Type-A 5Gbps, 1 RJ-45 port , 1 HDMI port, 1 SD Card reader, 1 Headphone/Microphone Combo, 1 USB 2.0 Type A</p>
				</div>
				<div class="color-quality">
					<div class="color-quality-left">
						...
						<ul>
							...
							<li><a href="#" style="color: gray;">Charcoal Gray</a></li><br>
				...
				<div class="occasional">
					...
					<div class="colr ert">
						<div class="check">
							<label class="checkbox"><input type="checkbox" name="checkbox" ><i> </i>8GB RAM+512GB SSD</label>
						</div>
					</div>
			...
			<div class="sap_tabs">	
				<div id="horizontalTab1" style="display: block; width: 100%; margin: 0px;">
					...
					<div class="tab-1 resp-tab-content additional_info_grid" aria-labelledby="tab_item-0">
						<h3>The Best Laptop Under ₹53,999</h3>
						<p>>The RedmiBook 15 Pro is primarily designed for office work. It features a 15-inch 1080p display, an 11th gen Intel Core i5 processor, 8GB RAM, and 512GB NVMe SSD storage.
                            ...
                            The RedmiBook 15 Pro has a 15-inch, 1920x1080 resolution, 60Hz TN LCD panel.</p>
					</div>	
						...
						<div class="additional_info_sub_grids">
							...
							<div class="col-xs-10 additional_info_sub_grid_right">
								<div class="additional_info_sub_grid_rightl">
									...
									<h3>Rahul Yadav</h3>
									<h5>Dec 06, 2021.</h5>
									<p>Very Best Laptop Under 48999. It Has Very Smooth Display and Battery Performance is Very High</p>
								</div>
						...
						<div class="additional_info_sub_grids">
							...
							<div class="col-xs-10 additional_info_sub_grid_right">
								<div class="additional_info_sub_grid_rightl">
									<h3>Vikas Singh</h3>
									<h5>Jan 21, 2022.</h5>
									<p>Worth Of ₹48999 And Performance Very High.</p>
								</div>
								<div class="additional_info_sub_grid_rightr">
									<div class="rating">
										<div class="rating-left">
