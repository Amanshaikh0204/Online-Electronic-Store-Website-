		...
		<div class="container">
			<div class="col-md-4 single-left">
				<div class="flexslider">
					<ul class="slides">
						<li data-thumb="images/w1.jpg">
							<div class="thumb-image"> <img src="images/w1.jpeg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li>
						<li data-thumb="images/w3.jpg">
							 <div class="thumb-image"> <img src="images/w3.jpeg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li>
						<li data-thumb="images/w4.jpg">
						   <div class="thumb-image"> <img src="images/w4.jpeg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li> 
					</ul>
				</div>
				<!-- flexslider -->
			...
			<div class="col-md-8 single-right">
				<h3>ONIDA 7 kg 5 star With Crystal Drum Technology Fully Automatic Top Load Grey </h3>
				
				<div class="description">
					<h5><i>Description</i></h5>
					<p>Fully Automatic Top Load Washing Machines are ergonomically friendly and provide great wash quality<br>
                        750 rpm : Higher the spin speed, lower the drying time<br>
                ...
                <div class="occasional">
					...
					<div class="colr ert">
						<div class="check">
							<label class="checkbox"><input type="checkbox" name="checkbox" ><i> </i>6.2 Kg</label>
						</div>
					</div>
					<div class="colr">
						<div class="check">
							<label class="checkbox"><input type="checkbox" name="checkbox"><i> </i>7 Kg</label>
						</div>
					</div>
