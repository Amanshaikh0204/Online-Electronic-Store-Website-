	...
	<div class="breadcrumb_dress">
		<div class="container">
			<ul>
				...
				<li>Asus Vivobook Gaming Laptop</li>
			</ul>
		</div>
	</div>
	<!-- //breadcrumbs -->  
		...
		<div class="container">
			<div class="col-md-4 single-left">
				<div class="flexslider">
					<ul class="slides">
						<li data-thumb="images/l9.jpg">
							<div class="thumb-image"> <img src="images/l9.jpeg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li>
						<li data-thumb="images/l10.jpg">
							 <div class="thumb-image"> <img src="images/l10.jpeg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li>
						<li data-thumb="images/l11.jpg">
						   <div class="thumb-image"> <img src="images/l11.jpeg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li> 
					</ul>
				</div>
				<!-- flexslider -->
			...
			<div class="col-md-8 single-right">
				<h3>Asus Vivobook Gaming Laptop</h3>
				
				<div class="description">
					<h5><i>Description</i></h5>
					<p>Processor And Memory Features
                        ...
                        1920 x 1080 Pixel
                        Screen Type
                        Full HD LED Backlit Anti-glare Display (16:9, 250nits Brightness, NTSC: 45% Color Gamut, 80% Screen-to-body Ratio, IPS Level Panel)
                        Speakers
                        Built-in Speaker
                        Sound Properties
				...
				<div class="color-quality">
					<div class="color-quality-left">
						<h5>Colors : </h5>
						<ul>
                            <li><a href="#" style="color: black;">Dark Black</a></li>
			...
			<div class="sap_tabs">	
				<div id="horizontalTab1" style="display: block; width: 100%; margin: 0px;">
					...
					<div class="tab-1 resp-tab-content additional_info_grid" aria-labelledby="tab_item-0">
						<h3>The Best Laptop Under ₹57,999</h3>
						...
						<div class="additional_info_sub_grids">
							...
							<div class="col-xs-10 additional_info_sub_grid_right">
								<div class="additional_info_sub_grid_rightl">
									...
									<h3>Rahul Yadav</h3>
									<h5>Dec 06, 2021.</h5>
									<p>Very Best Laptop Under 57999. It Has Very Smooth Display and Battery Performance is Very High</p>
								</div>
						...
						<div class="additional_info_sub_grids">
							...
							<div class="col-xs-10 additional_info_sub_grid_right">
								<div class="additional_info_sub_grid_rightl">
									<h3>Vikas Singh</h3>
									<h5>Jan 21, 2022.</h5>
									<p>Worth Of ₹57999 And Performance Very High.</p>
								</div>
								<div class="additional_info_sub_grid_rightr">
									<div class="rating">
										<div class="rating-left">
