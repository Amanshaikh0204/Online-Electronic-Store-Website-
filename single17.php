	...
	<div class="single">
		<div class="container">
				...
				<div class="flexslider">
					<ul class="slides">
						<li data-thumb="images/d5.jpg">
							<div class="thumb-image"> <img src="images/d5.jpeg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li>
						<li data-thumb="images/d6.jpg">
							 <div class="thumb-image"> <img src="images/d6.jpeg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li>
						<li data-thumb="images/d7.jpg">
						   <div class="thumb-image"> <img src="images/d7.jpeg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li> 
					</ul>
				</div>
				<!-- flexslider -->
			...
			<div class="col-md-8 single-right">
				<h3>Redmi GPS Watch  (Black Strap, Regular)</h3>
				...
				<div class="description">
					...
					<p>In-built GPS: Dual satellite positioning system with GPS + GLONASS.
                        ...
                        Health features: 24/7 Heart Rate Monitoring, Sleep monitoring, Breathing exercises
				...
				<div class="occasional">
					...
					<div class="colr ert">
						<div class="check">
							<label class="checkbox"><input type="checkbox" name="checkbox" ><i> </i>Gray</label>
						</div>
                        <div class="check">
