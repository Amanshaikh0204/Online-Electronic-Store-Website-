		...
		<div class="container">
			<div class="col-md-4 single-left">
				<div class="flexslider">
					<ul class="slides">
						<li data-thumb="images/r1.jpg">
							<div class="thumb-image"> <img src="images/r1.jpeg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li>
						<li data-thumb="images/r3.jpg">
							 <div class="thumb-image"> <img src="images/r3.jpeg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li>
						<li data-thumb="images/r4.jpg">
						   <div class="thumb-image"> <img src="images/r4.jpeg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li> 
					</ul>
				</div>
				<!-- flexslider -->
			...
			<div class="col-md-8 single-right">
				<h3>SAMSUNG 198 L Direct Cool Single Door 4 Star Refrigerator with Base Drawer</h3>
				
				<div class="description">
					<h5><i>Description</i></h5>
					<p>198 L : Good for couples and small families<br>
                        Digital Inverter Compressor<br>
                        4 Star : For Energy savings up to 45%<br>
                        Direct Cool : Economical, consumes less electricity, requires manual defrosting<br>
