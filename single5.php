	...
	<div class="breadcrumb_dress">
		<div class="container">
			<ul>
				...
				<li>boAt Rockerz 370 Bluetooth wireless on ear headphone with mic</li>
			</ul>
		</div>
	</div>
	<!-- //breadcrumbs -->  
		...
		<div class="container">
			<div class="col-md-4 single-left">
				<div class="flexslider">
					<ul class="slides">
						<li data-thumb="images/e8.jpg">
							<div class="thumb-image"> <img src="images/e8.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li>
						<li data-thumb="images/e9.jpg">
							 <div class="thumb-image"> <img src="images/e9.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li>
						<li data-thumb="images/e10.jpg">
						   <div class="thumb-image"> <img src="images/e10.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li> 
					</ul>
				</div>
				<!-- flexslider -->
			...
			<div class="col-md-8 single-right">
				<h3>boAt Rockerz 370 Bluetooth wireless on ear headphone with mic</h3>
...
Rockerz 370 come equipped with latest Bluetooth v5.0 for instant wireless connectivity. The powerful 300mAh battery provides up to 8 Hours of audio bliss. 40mm Dynamic Drivers supply immersive High Definition sound</p>
				</div>
				<div class="color-quality">
					<div class="color-quality-left">
						<h5>Colors : </h5>
						<ul>
							<li><a href="#" style="color: black;">Buoyant Black</a></li><br>
							<li><a href="#" style="color: lightgreen;">Gregarious Green</a></li><br>
			...
			<div class="sap_tabs">	
				<div id="horizontalTab1" style="display: block; width: 100%; margin: 0px;">
					...
					<div class="tab-1 resp-tab-content additional_info_grid" aria-labelledby="tab_item-0">
						...
						<p>>Bluetooth: It has Bluetooth v5.0 with a range of 10m and is compatible with Android & iOS
                            Battery: Rockerz 370 offers a playback time of up to 12 hours.. Frequency Response 20Hz-20KHz,Sensitivity (dB) 79dB±3DB,Impedance 32Ω. Driver Type:Moving Coil Driver
                            Lightweight Ergonomic Design with Easy Controls</p>
					</div>	
						...
						<div class="additional_info_sub_grids">
							...
							<div class="col-xs-10 additional_info_sub_grid_right">
								<div class="additional_info_sub_grid_rightl">
									...
									<h3>Rahul Yadav</h3>
									<h5>Dec 06, 2021.</h5>
									<p>Very Best Bluetooth Headset Under 899. Sound Quality Is Very Nice.</p>
								</div>
						...
						<div class="additional_info_sub_grids">
							...
							<div class="col-xs-10 additional_info_sub_grid_right">
								<div class="additional_info_sub_grid_rightl">
									<h3>Vikas Singh</h3>
									<h5>Jan 21, 2022.</h5>
									<p>Very Best Headset Under 899. Sound Quality Is Very Nice</p>
								</div>
								<div class="additional_info_sub_grid_rightr">
									<div class="rating">
										<div class="rating-left">
