		...
		<div class="container">
			<div class="col-md-4 single-left">
				<div class="flexslider">
					<ul class="slides">
						<li data-thumb="images/l5.jpg">
							<div class="thumb-image"> <img src="images/l5.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li>
						<li data-thumb="images/l7.jpg">
							 <div class="thumb-image"> <img src="images/l7.jpeg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li>
						<li data-thumb="images/l8.jpg">
						   <div class="thumb-image"> <img src="images/l8.jpeg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li> 
					</ul>
				</div>
				<!-- flexslider -->
			...
			<div class="col-md-8 single-right">
				...
				<div class="description">
					...
					<p>Dominate the Game: Great performance meets long battery life with the Intel Core i5-11400H Processor - up to 4.5GHz, 6 cores, 12 threads, 12MB Intel Smart Cache.<br> Avail Xbox Game Pass for PC
                       ...
                       <br> Visual Intensity: Explore game worlds in Full HD detail on the 15.6" widescreen LED-backlit IPS display with 1920 x 1080 resolution, 144Hz refresh rate and 80% screen-to-body/16:9 aspect ratio
                     <br>   Internal Specifications: 8GB DDR4 3200MHz memory (2 DDR4 Slots Total, Maximum 32GB); 256 GB NVMe SSD (2 x PCIe M.2 Slots) 1 TB 2.5" 7200 RPM HDD Available)
                      <br>  Prioritize Your Gameplay: Killer DoubleShot Pro with Ethernet E2600 and Wi-Fi 6 AX1650 lets you use Wi-Fi and Ethernet at the same time.</p>
				</div>
				...
				<div class="occasional">
					...
					<div class="colr ert">
						<div class="check">
							<label class="checkbox"><input type="checkbox" name="checkbox" ><i> </i>8GB RAM+256GB SSD+1TB HDD+4GB GRAPHIC CARD</label>
						</div>
					</div>
			...
			<div class="sap_tabs">	
				<div id="horizontalTab1" style="display: block; width: 100%; margin: 0px;">
					...
					<div class="tab-1 resp-tab-content additional_info_grid" aria-labelledby="tab_item-0">
						<h3>The Best Laptop Under ₹55,999</h3>
						<p>>Dominate the Game: Great performance meets long battery life with the Intel Core i5-11400H Processor - up to 4.5GHz, 6 cores, 12 threads, 12MB Intel Smart Cache. Avail Xbox Game Pass for PC
                            RTX, It's On: The latest NVIDIA GeForce RTX 3050 (4GB dedicated GDDR6 VRAM) is powered by award-winning architecture with new Ray Tracing Cores, Tensor Cores, and streaming multiprocessors support DirectX 12 Ultimate for the ultimate gaming performance.</p>
					</div>	
						...
						<div class="additional_info_sub_grids">
							...
							<div class="col-xs-10 additional_info_sub_grid_right">
								<div class="additional_info_sub_grid_rightl">
									...
									<h3>Rahul Yadav</h3>
									<h5>Dec 06, 2021.</h5>
									<p>Very Best Laptop Under 65999. It Has Very Smooth Display and Battery Performance is Very High</p>
								</div>
						...
						<div class="additional_info_sub_grids">
							...
							<div class="col-xs-10 additional_info_sub_grid_right">
								<div class="additional_info_sub_grid_rightl">
									<h3>Vikas Singh</h3>
									<h5>Jan 21, 2022.</h5>
									<p>Worth Of ₹65999 And Performance Very High.</p>
								</div>
								<div class="additional_info_sub_grid_rightr">
									<div class="rating">
										<div class="rating-left">
