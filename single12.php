	...
	<div class="breadcrumb_dress">
		<div class="container">
			<ul>
				...
				<li>BAJAJ Rex 750 Mixer Grinder</li>
			</ul>
		</div>
	</div>
	<!-- //breadcrumbs -->  
	...
	<div class="single">
		<div class="container">
				...
				<div class="flexslider">
					<ul class="slides">
						<li data-thumb="images/m1.jpg">
							<div class="thumb-image"> <img src="images/m1.jpeg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li>
						<li data-thumb="images/m2.jpg">
							 <div class="thumb-image"> <img src="images/m2.jpeg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li>
						<li data-thumb="images/m3.jpg">
						   <div class="thumb-image"> <img src="images/m3.jpeg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li> 
					</ul>
				</div>
				<!-- flexslider -->
			...
			<div class="col-md-8 single-right">
				<h3>BAJAJ Rex 750 Mixer Grinder (4 Jars, White)</h3>
			...
			<div class="sap_tabs">	
				<div id="horizontalTab1" style="display: block; width: 100%; margin: 0px;">
					...
					<div class="tab-1 resp-tab-content additional_info_grid" aria-labelledby="tab_item-0">
						<h3>BAJAJ Rex 750 Mixer Grinder</h3>
						<p>>Bajaj Rex 750W Mixer Grinder comes with 4 jars having a capcity of 1.8L juicer jar, 1.5L liquidising jar, 1L dry jar and 0.4L chutney jar. It comes with Titan Motor and Multi-function blade.</p>
					</div>	
